...
$texto = "El código postal es 1234567";
...
$info = "Nombre: Alvaro, Edad: 32, Ciudad: Panama, telefono:67220210" ;
$patron = "/Nombre: ([^,]+), Edad: (\d+), Ciudad: ([^,]+)\ ,telefono:(\d+)/";
if (preg_match($patron, $info, $coincidencias)) {
    ...
    echo "telefono:{$coincidencias[4]}</br>";
}
