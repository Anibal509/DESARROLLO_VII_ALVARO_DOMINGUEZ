...
$frutas = ["Manzana", "mandarina", "papaya", "Uva", "Pera"];
...
$misCanciones = ["On my on","Yo y Tu","Soleado","Miracle","Can you stop the rain","gallina fina"]; // Reemplaza esto con tu array de canciones
...
$playlist = [
    "Rock" => ["Bohemian Rhapsody", "Stairway to Heaven","gallina fina"],
    "Pop" => ["Thriller", "Billie Jean", "Beat It","Patria"],
