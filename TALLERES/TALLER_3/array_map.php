...
$nombres = ["Ana", "Carlos", "Beatriz","Maria","Catalina"];
$apellidos = ["García", "Rodríguez", "López","Pablo","Josue"];
...
$productos = [
    ...
    ["nombre" => "Teléfono", "precio" => 1000],
    ["nombre" => "Tablet", "precio" => 450]
];

$productosConDescuento = array_map(function($producto) {
    $producto['precio_descuento'] = $producto['precio'] * 0.8; // 10% de descuento
    return $producto;
}, $productos);
