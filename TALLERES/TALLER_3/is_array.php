...
$miArray = ["madre","Padre","Hijo","Nieto"]; // Reemplaza esto con tu propio array
$miString = "Parinetes"; // Reemplaza esto con tu propio string
$miNumero = 4; // Reemplaza esto con tu propio número
