...
$misComidas = ["Arroz con pollo ", "lasana", "tamales"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["arvejas", "pollo asado", "tortelinis"]; // Reemplaza con las comidas favoritas de tu amigo
