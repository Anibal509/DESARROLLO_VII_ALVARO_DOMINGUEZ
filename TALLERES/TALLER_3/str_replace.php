...
$fraseModificada = str_replace("amarillo", "gris", $frase);
...
$miFrase = "La arena es infinita "; // Reemplaza esto con tu frase
...
$texto = "Sandias y bananas son frutas. Me gustan las sandias  y las bananas.";
$buscar = ["sandias", "bananas"];
$reemplazar = ["kiwi", "uvas"];
