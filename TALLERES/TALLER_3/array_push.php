...
$misAmigos = ["Maria1","Maria2","Maria3","Maria4","Maria5",]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Luis", "Cristian"); // Reemplaza las comillas vacías con los nombres de tus amigos
